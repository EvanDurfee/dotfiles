# Generated by Powerlevel10k configuration wizard on 2021-02-15 at 21:45 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=52
  ...
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_BACKGROUND=52
  ...
  # Styling for DEFAULT_NON_EXISTENT.
  # typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_VISUAL_IDENTIFIER_EXPANSION='⭐'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_BACKGROUND=52
  # typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_FOREGROUND=254
  # typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_SHORTENED_FOREGROUND=250
  # typeset -g POWERLEVEL9K_DIR_DEFAULT_NON_EXISTENT_ANCHOR_FOREGROUND=255
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=106
  # typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=220
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=106
...
#    local       meta='%7F' # white foreground
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLED_WORKDIR_PATTERN='~|/btrfs/*|/mnt/*'
