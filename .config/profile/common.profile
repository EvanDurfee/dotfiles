...
# To override, create an overrides.profile, which will be sourced at the end.

# Source this file
# ln -s ~/.config/profile/common.profile ~/.profile
# OR
# ~/.profile: [ -e "~/.config/profile/common.profile" ] && . "~/.config/profile/common.profile"
...
# Less
# Must run mkdir -p "$XDG_CACHE_HOME"/less
...
# PSQL
# Must also run mkdir -p "$XDG_CONFIG_HOME/pg" && mkdir -p "$XDG_CACHE_HOME/pg"
...
# ZSH (set via .zshenv instead)
# export ZDOTDIR="$XDG_CONFIG_HOME"/zsh

# Overrides
[ -e "$XDG_CONFIG_HOME/profile/overrides.profile" ] && . "$XDG_CONFIG_HOME/profile/overrides.profile"
